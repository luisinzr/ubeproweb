...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-07-2025 a las 23:44:36
...
(2, 'Cien Años de Soledad', 'Gabriel García Márquez', 1967, 'Realismo Mágico', 4),
...
(9, 'Moby Dick', 'Herman Melville', 1851, 'Aventura', 2),
...
(14, 'El Nombre de la Rosa', 'Umberto Eco', 1980, 'Misterio', 2),
(15, 'La Sombra del Viento', 'Carlos Ruiz Zafón', 2001, 'Misterio', 6),
...
--
-- Estructura de tabla para la tabla `selected_books`
--
...
--
-- Volcado de datos para la tabla `selected_books`
--

INSERT INTO `selected_books` (`id`, `user_id`, `book_id`, `selected_at`) VALUES
(1, 15, 3, '2025-07-11 21:18:33'),
(2, 15, 14, '2025-07-11 21:18:38'),
(3, 15, 15, '2025-07-11 21:18:41'),
(4, 15, 9, '2025-07-11 21:18:45');
...
(4, 'Maria', 'maria@gmail.com', '$2y$10$znqtXNwj43/g42x6gb/wq.eh95L5h87/6Q/7nSuYZrJxOa.6/xkBK', 3),
(6, 'PEDRO', 'pedro@gmail.com', '$2y$10$6jmO6M6Al/o9utZkIkGXquHNVPV0957mK1tn3mLe5KQl/CaP2ODJ2', 3),
(14, 'SIMON', 'simon@gmail.com', '$2y$10$micj4VVa/RN/.dFAPFZ3GuQGMVSdTGdP.icyMHZ2bQRAZIkQpMz3C', 2),
(15, 'PEPE', 'pepe@gmail.com', '$2y$10$EfT6d.mjNxKOhwAKtHOJw.yNAWY0/WC9QtcgIEst7sTZNJBVADBmC', 3),
(16, 'Camila', 'camila@gmail.com', '$2y$10$efoDAPRXyukLyuHyqljNreLTkojl2XmqN3dL50XzyP6FJS7rJAIKG', 1);
...
--
-- Indices de la tabla `selected_books`
--
...
--
-- AUTO_INCREMENT de la tabla `selected_books`
--
ALTER TABLE `selected_books`
...
--
-- Filtros para la tabla `selected_books`
--
ALTER TABLE `selected_books`
  ADD CONSTRAINT `selected_books_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `selected_books_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE;
...
(31, 'Análisis de Requisitos', 'Recolectar y documentar requerimientos del cliente.', 'Pendiente', 107),
...
(34, 'Desarrollo Frontend', 'Maquetar la interfaz usando HTML, CSS y Bootstrap.', 'Pendiente', 123),
(35, 'Implementación de Login', 'Desarrollar sistema de autenticación con sesiones.', 'Pendiente', 123),
(36, 'Gestión de Usuarios', 'Crear funcionalidades para administrar usuarios.', 'Pendiente', NULL),
(37, 'Control de Accesos', 'Restringir accesos según roles definidos.', 'Pendiente', 107),
(38, 'Panel de Estadísticas', 'Mostrar métricas y reportes del proyecto.', 'Pendiente', 107),
(39, 'Sistema de Comentarios', 'Implementar feedback para tareas asignadas.', 'Pendiente', 107),
(40, 'Documentación Final', 'Redactar manual técnico y de usuario.', 'Pendiente', NULL),
(41, 'Integración con API Externa', 'Conectar sistema con API de terceros.', 'Pendiente', 101),
...
(123, 'Marta', 'marta@gmail.com', '2222', 3),
(124, 'Carmen', 'carmen@gmail.com', '2222', 3);
...
--
-- Base de datos: `cp5_tareas_mvc`
--
CREATE DATABASE IF NOT EXISTS `cp5_tareas_mvc` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cp5_tareas_mvc`;
...
INSERT INTO `tareas` (`id`, `titulo`, `descripcion`, `estado`, `usuario_id`, `fecha_creacion`) VALUES
(1, 'Investigar nueva tecnología X', 'Analizar las funcionalidades y compatibilidad de la tecnología X para el proyecto.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(2, 'Planificar reunión semanal', 'Preparar agenda y convocar a los miembros del equipo para la reunión del lunes.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(3, 'Diseñar base de datos del módulo Y', 'Crear el esquema de la base de datos para el nuevo módulo Y, incluyendo tablas y relaciones.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(4, 'Desarrollar interfaz de usuario del login', 'Implementar los componentes visuales del formulario de inicio de sesión.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(5, 'Implementar lógica de negocio para registro', 'Codificar la validación y el almacenamiento de datos de nuevos usuarios.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(6, 'Crear pruebas unitarias para el API Z', 'Escribir tests para asegurar la funcionalidad correcta de los endpoints del API Z.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(7, 'Optimizar consultas de informes', 'Revisar y mejorar el rendimiento de las consultas SQL usadas en la generación de informes.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(8, 'Documentar API REST para desarrolladores', 'Escribir la documentación técnica completa para el consumo de la API REST.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(9, 'Realizar control de calidad del módulo W', 'Ejecutar pruebas exhaustivas en el módulo W para identificar errores y bugs.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(10, 'Configurar entorno de desarrollo local', 'Instalar todas las dependencias y herramientas necesarias para el equipo.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(11, 'Investigar soluciones de pago online', 'Evaluar diferentes pasarelas de pago y sus características.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(12, 'Preparar presentación para stakeholders', 'Diseñar diapositivas y resumir el progreso del proyecto para la próxima reunión.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(13, 'Refactorizar código antiguo del sistema', 'Reestructurar secciones del código base para mejorar su legibilidad y mantenimiento.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(14, 'Implementar sistema de notificaciones por email', 'Desarrollar la funcionalidad para enviar alertas por correo electrónico a los usuarios.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(15, 'Generar reportes mensuales de actividad', 'Extraer y procesar datos para los informes de rendimiento del mes.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(16, 'Soporte técnico a usuarios (Tickets)', 'Atender y resolver tickets de soporte abiertos por los usuarios.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(17, 'Investigar vulnerabilidades de seguridad', 'Realizar un análisis de seguridad para identificar posibles puntos débiles en la aplicación.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(18, 'Actualizar dependencias de librerías', 'Asegurar que todas las librerías externas estén en sus versiones más recientes.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(19, 'Diseñar flujo de usuario para la compra', 'Mapear la experiencia del usuario desde la selección del producto hasta la confirmación de compra.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(20, 'Desarrollar funcionalidad de búsqueda avanzada', 'Crear un motor de búsqueda con filtros y opciones avanzadas.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(21, 'Migrar datos de servidor antiguo', 'Transferir toda la información de la base de datos de un servidor a otro.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(22, 'Crear panel de administración de usuarios', 'Construir la interfaz para gestionar los usuarios del sistema (CRUD).', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(23, 'Configurar balanceador de carga', 'Implementar una solución para distribuir el tráfico entre múltiples servidores.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(24, 'Investigar integración con redes sociales', 'Explorar opciones para permitir el inicio de sesión o compartir contenido en redes sociales.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(25, 'Escribir manual de usuario para la app', 'Crear una guía paso a paso para que los usuarios puedan utilizar la aplicación.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(26, 'Implementar caché de datos para rendimiento', 'Configurar un sistema de caché para acelerar el acceso a la información frecuente.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(27, 'Desarrollar API para móviles', 'Crear una interfaz de programación de aplicaciones específica para la aplicación móvil.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(28, 'Realizar pruebas de carga y estrés', 'Simular un alto número de usuarios para verificar la estabilidad del sistema.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(29, 'Actualizar certificado SSL del dominio', 'Renovar el certificado de seguridad para mantener la conexión cifrada.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(30, 'Diseñar nueva página de inicio', 'Rediseñar la página principal del sitio web para mejorar la experiencia de usuario.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(31, 'Programar notificaciones push para la app', 'Desarrollar la capacidad de enviar mensajes emergentes a los usuarios móviles.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(32, 'Crear scripts de respaldo de base de datos', 'Automatizar el proceso de copia de seguridad de la información.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(33, 'Investigar herramientas de monitoreo', 'Analizar diferentes plataformas para supervisar el rendimiento y la salud del sistema.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(34, 'Realizar auditoría de código de seguridad', 'Revisar el código en busca de vulnerabilidades de seguridad y buenas prácticas.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(35, 'Preparar ambiente de staging', 'Configurar un entorno de pruebas idéntico al de producción para pre-despliegues.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(36, 'Implementar sistema de comentarios en blog', 'Añadir la funcionalidad para que los usuarios puedan dejar comentarios en las publicaciones.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(37, 'Diseñar iconos y elementos gráficos', 'Crear los elementos visuales necesarios para la interfaz de usuario.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(38, 'Desarrollar funcionalidad de recuperación de contraseña', 'Permitir a los usuarios restablecer sus contraseñas olvidadas.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(39, 'Automatizar despliegues (CI/CD)', 'Configurar un sistema de integración y entrega continua para despliegues automáticos.', 'Pendiente', NULL, '2025-07-09 18:54:12'),
(40, 'Evaluar rendimiento del servidor de base de datos', 'Monitorear y optimizar la base de datos para asegurar su velocidad y eficiencia.', 'Pendiente', NULL, '2025-07-09 18:54:12');
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_rol_id` FOREIGN KEY (`rol_id`) REFERENCES `roles` (`rol_id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
...
('root', '[{\"db\":\"biblioteca_db\",\"table\":\"books\"},{\"db\":\"biblioteca_db\",\"table\":\"selected_books\"},{\"db\":\"biblioteca_db\",\"table\":\"roles\"},{\"db\":\"biblioteca_db\",\"table\":\"users\"},{\"db\":\"biblioteca_db\",\"table\":\"transactions\"},{\"db\":\"mi_login_db\",\"table\":\"usuarios\"},{\"db\":\"cp5_tareas\",\"table\":\"usuarios\"},{\"db\":\"cp5_tareas\",\"table\":\"tareas\"},{\"db\":\"cp5_tareas\",\"table\":\"roles\"},{\"db\":\"biblioteca_online\",\"table\":\"usuarios\"}]');
...
('root', '2025-07-11 19:18:02', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
